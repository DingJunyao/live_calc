  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return asyncDetail.when(
      loading: () => const Scaffold(
        appBar: AppBar(title: Text('菜谱详情')),
        body: LoadingIndicator(message: '加载菜谱...'),
      ),
      error: (e, _) => Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (detail.description != null)
                      Text(detail.description!, style: theme.textTheme.bodyMedium?.copyWith(
                    ...
                    if (detail.totalCost != null)
                      Container(
                        ...
                        child: Text(
                          '总成本：¥${detail.totalCost!.toStringAsFixed(2)}',
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('成本与营养分析'),
                    ),

                    const SizedBox(height: 24),

                    // Ingredients
                    Text('食材清单', style: theme.textTheme.titleMedium),
                    const SizedBox(height: 12),
                    if (detail.ingredients.isEmpty)
                      Text('暂无食材', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.outline))
                    else
                    ...
                    if (detail.steps.isEmpty)
                      Text('暂无步骤', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.outline))
                    else
