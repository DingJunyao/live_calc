...
如果菜谱包含你设置的黑名单原料，则不会在列表显示。但你仍然能够通过菜谱详情查看。
...
点击导航栏的图表按钮，能够进入菜谱的分析页面。

![菜谱分析](img/recipe_analyse.jpeg)

该页面展示了：

- 菜谱价格中，各原料的成本占比，以及趋势
- 菜谱的各营养素，各原料的贡献情况
- 各食材到哪家商家购买比较实惠，以及价格对比
...
发布前的菜谱本身是你的私有数据，增删改直接生效、不需审核。但是发布之后，所有用户都可以修改（经管理员审核后），只有管理员可以删除。详见 [提议审核台](admin/review.md)。
