...
-- 先检查是否已存在，避免重复执行
INSERT IGNORE INTO ingredient_categories (name, display_name, description, sort_order, is_active, created_at, updated_at)
SELECT 'soy', '豆制品', '豆腐、豆浆、豆皮、腐竹等', 8, 1, NOW(), NOW()
